...
object SeedData {
    ...
    val debtorTransactions = listOf(
        DebtorTransaction(1, "ACC001", daysAgo(10), "Invoice", 1001, 270.0),
        DebtorTransaction(2, "ACC001", daysAgo(5), "Invoice", 1002, 0.0),
        DebtorTransaction(3, "ACC002", daysAgo(20), "Invoice", 1003, 750.0)
    )

    val stockTransactions = listOf(
        StockTransaction(1, "STK001", daysAgo(30), "Sale", 1001, 1, 800.0,1200.0),
        StockTransaction(1, "STK001", daysAgo(10), "Sale", 1002, 2, 2500.0,3500.0)
    )
}